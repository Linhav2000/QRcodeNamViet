...
from Modules.Camera.MvImport.PixelType_header import *
from Modules.Camera.MvImport.CameraParams_const import *
from Modules.Camera.MvImport.CameraParams_header import *
from Modules.Camera.MvImport.MvErrorDefine_const import *
try:
    # os.chdir("C:\Program Files (x86)\Common Files\MVS\Runtime\Win64_x64")
    if platform.machine().endswith('64'):
        MvCamCtrldll = ctypes.windll.LoadLibrary(r"C:\Program Files (x86)\Common Files\MVS\Runtime\Win64_x64\MvCameraControl.dll")
    else:
        MvCamCtrldll = ctypes.windll.LoadLibrary(r"C:\Program Files (x86)\Common Files\MVS\Runtime\Win32_i86\MvCameraControl.dll")
except Exception as error:
    print(f"Read MVCameraControll DLL not successfully! detail: {error}")
    pass
# 用于回调函数传入相机实例
