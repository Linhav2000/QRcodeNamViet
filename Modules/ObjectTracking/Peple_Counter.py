...
vs = cv.VideoCapture("./Modulus/ObjectTracking/coconut_counting.mp4")
...
while True:
	...
	if "" is not None and frame is None:
		break
	...
	# the writer
	if "" is not None and writer is None:
		fourcc = cv.VideoWriter_fourcc(*"MJPG")
		writer = cv.VideoWriter("", fourcc, 30,
			(W, H), True)
